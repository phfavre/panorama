    ...
    <div class="col-md-14">
      <div class="roompage_title_div">
        <div class="row">
          ...
          <div class="col-md-5 roompage_roomname">Niesenhorn</div>
        </div>
      </div>
          ...
          <div class="col-md-8">
            <div class="single-item roomview_carousel">
              <div class="roomitem_carousel sel_elem">
                <img src="img/niesenhorn_01.jpg">
              </div>
              <div class="roomitem_carousel sel_elem">
                <img src="img/niesenhorn_02.jpg">
              </div>
              <div class="roomitem_carousel sel_elem">
                <img src="img/niesenhorn_03.jpg">
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="roompage_room_fare">
              ...
              <a href="./bookinfo?roomname=niesenhorn" type="button" class="btn roompage_moreinfo_button">Book Info</a>
            </div>
          </div>
        </div>
      </div>
